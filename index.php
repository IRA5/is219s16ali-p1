...
<body>
	...
	<header id="summary">
							<h3 class="in front &amp; backend web development, database design, integration, 
							implementation, software development, network.</h3>
	...
	<section>
		<div class="Interest"></div>
						...
						<h5 class="Want to protect the country against attack and want to work for the military."<h5>
									</div>
								</div>
							</div>
							<div class="Education">
								<div class="William. L. Dickinson HS">
								<div class="Hudson County Community College">
								<div class="New Jersey Institute Of Technology">
									</div>
								</div>
	...
	<h5"Dear Unsolicited Recruiters"<h5>
	<br/><br/>
